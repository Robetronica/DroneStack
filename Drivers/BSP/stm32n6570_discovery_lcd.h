/**
  ******************************************************************************
  * @file    stm32n6570_discovery_lcd.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32n6570_discovery_lcd.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32N6570_DISCOVERY_LCD_H
#define STM32N6570_DISCOVERY_LCD_H
...
/** @addtogroup STM32N6570_DISCOVERY_LCD
  * @{
  */

/** @defgroup STM32N6570_DISCOVERY_LCD_Exported_Constants LCD Exported Constants
  * @{
  */
...
#define LCD_DISP_EN_GPIO_PORT                GPIOG
#define LCD_DISP_EN_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOG_CLK_ENABLE()
#define LCD_DISP_EN_GPIO_CLK_DISABLE()       __HAL_RCC_GPIOG_CLK_DISABLE()

/* LCD Backlight Control pin*/
#define LCD_DISP_BL_PIN                      GPIO_PIN_6
#define LCD_DISP_BL_GPIO_PORT                GPIOQ
#define LCD_DISP_BL_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOQ_CLK_ENABLE()
#define LCD_DISP_BL_GPIO_CLK_DISABLE()       __HAL_RCC_GPIOQ_CLK_DISABLE()

/* LCD Reset pin (active low) */
#define LCD_DISP_NRST_PIN                    GPIO_PIN_1
#define LCD_DISP_NRST_GPIO_PORT              GPIOE
#define LCD_DISP_NRST_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOE_CLK_ENABLE()
#define LCD_DISP_NRST_GPIO_CLK_DISABLE()     __HAL_RCC_GPIOE_CLK_DISABLE()
...
/** @defgroup STM32N6570_DISCOVERY_LCD_Exported_Types STM32N6570_DK LCD Exported Types
  * @{
  */
typedef struct
{
...
/** @addtogroup STM32N6570_DISCOVERY_LCD_Exported_Variables
  * @{
  */
...
/** @addtogroup STM32N6570_DISCOVERY_LCD_Exported_Functions
  * @{
  */
/* Initialization APIs */
...
/* Private constants --------------------------------------------------------*/
/** @defgroup STM32N6570_DISCOVERY_LCD_Private_Constants Private Constants
  * @{
  */
/* Legacy defines */
